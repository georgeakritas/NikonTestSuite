...
formatter.scenario({
  "line": 25,
  "name": "TC-IMG-Check-6 - Preorder - In Stock - Release Date Reached",
  "description": "",
  "id": "us-img-regression-test-cases;tc-img-check-6---preorder---in-stock---release-date-reached",
  "type": "scenario",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "line": 26,
  "name": "I have navigated to the IMG PDP of the regular product 2161",
  "keyword": "Given "
});
formatter.step({
  "line": 27,
...
formatter.step({
  "line": 30,
  "name": "I complete the order using a discover",
  "keyword": "Then "
});
formatter.match({
  "arguments": [
