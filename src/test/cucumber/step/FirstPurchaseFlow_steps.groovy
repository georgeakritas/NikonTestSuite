...
Given(~'I have navigated to the SRO PDP of the regular product (.*)') { String SKU ->
	...
	urlstring= 'http://e2e-en-us-sro.nikontest.com/en/Nikon-Products/Product/Digital-SLR-Cameras/'+SKU +'/D4S.html' //'http://stg-en-us-sro.nikontest.com/en/Nikon-Products/Product/dslr-cameras/'+SKU+ '/D4S.html'
	PDP.setTesturl(urlstring)
	to PDP
}
