...
Given I have navigated to the Brazil IMG PDP of the product 1515
Then I add the product to the cart
Given I have navigated to the Brazil IMG PDP of the product 1902
Then I add the product to the cart
Then I navigate to the BR cart
Then I proceed to check out
Then I complete the order using a visa
